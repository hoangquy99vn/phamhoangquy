    	...
    	<div class="container">
    		<div class="row">
    			<div class="col-lg-6 mb-5 ftco-animate">
    				<a href="assets/images/product-1.png" class="image-popup prod-img-bg"><img src="assets/images/product-1.png" class="img-fluid" alt="Colorlib Template"></a>
    			</div>
          	...
          	<p><a href="cart" class="btn btn-black py-3 px-5 mr-2">Add to Cart</a><a href="cart.html" class="btn btn-primary py-3 px-5">Buy now</a></p>
    			</div>
    		</div>
